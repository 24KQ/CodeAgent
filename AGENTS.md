...
Single-context: one `CONTEXT.md` + `docs/adr/` at the repo root (created lazily; proceed silently if absent — design decisions currently live in `docs/*_DESIGN.md`). See `docs/agents/domain.md`.
